...
*/}}
{{- define "clinic-booking-api.name" -}}
...
helm.sh/chart: {{ include "clinic-booking-api.chart" . }}
{{ include "clinic-booking-api.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
app.kubernetes.io/name: {{ include "clinic-booking-api.name" . }}
